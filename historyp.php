                ...
                <div class="row">
                  ...
                  $user_id= $_SESSION['user_id'];
                    ...
                    if ($dbc) {
                        ...
                        // if dbc is empty
                        if ($dbc->num_rows==0) {
                            echo "<h5>You have not book an appointment with any Doctor!</h5>";
                        }

                        //if patient has a book an appointment
                        else{
                                $count=1;
                            echo "<table class='table table-bordered table-striped table-hover'>";
                            echo "<thead><th>S/N</th><th>Reason</th><th>Specialisation</th><th>Date Schedule</th><th>status</th></thead>";
                            while ($row=mysqli_fetch_array($dbc)) {
                                ...
                                elseif ($row['status']==2) {
                                    echo"<button class='btn btn-danger'>Reschedule appointment</button>";
                                }
                                else{
